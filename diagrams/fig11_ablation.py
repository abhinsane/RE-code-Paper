...
Data from paper/far-reduction.md
"""
import numpy as np
import matplotlib
matplotlib.use("Agg")
...
# ── Ablation data (from far-reduction.md) ─────────────────────────────────────
methods = [
    "Baseline\n(t=0.80)",
    "+ ROC-optimal\nthreshold\n(t=0.818)",
    "+ Multi-impression\naveraging",
...
eer   = [8.18, 2.61, 1.80, 1.10, 0.65]   # EER % (approx from far-reduction.md)
...
plt.tight_layout()
out = "diagrams/fig11_ablation.png"
